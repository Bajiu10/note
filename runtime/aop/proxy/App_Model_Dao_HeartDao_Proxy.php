...
class HeartDao
{
    ...
    {
        return Heart::where('comment_id', $commentId)->when($userId, fn($builder) => $builder->where('user_id', $userId))->exists();
    }
    /**
     * @param      $commentId
     * @param null $userId
    ...
    {
        return $this->query->table('hearts')->where('comment_id', $commentId)->when($userId, fn($builder) => $builder->where('user_id', $userId))->delete();
    }
    /**
     * @param $data
     *
